 ...
 */
final class Version20200610071933 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program CHANGE category category_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE episode ADD season_id INT NOT NULL, DROP season');
        ...
        $this->addSql('ALTER TABLE season ADD program_id INT NOT NULL, DROP program');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE episode ADD season INT DEFAULT NULL, DROP season_id');
        ...
        $this->addSql('ALTER TABLE program DROP FOREIGN KEY FK_92ED778412469DE2');
        $this->addSql('DROP INDEX IDX_92ED778412469DE2 ON program');
        $this->addSql('ALTER TABLE program CHANGE category_id category INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE season ADD program INT DEFAULT NULL, DROP program_id');
